...
.proc Item_Clear
	...
	; $07B0～$07B7 char_12_type01_y ～ char_12_type02_x
	lda #< char_12_type01_y;下位
	sta REG0
	lda #> char_12_type01_y;上位
	sta REG1
	ldy #0
	lda #0
	loop_i_clr1:
	...
	; $07d8～$07ff char_12_type03_y ～ char_12_type12_x
	lda #< char_12_type03_y;下位
	sta REG0
	lda #> char_12_type03_y;上位
	sta REG1
	ldy #0
	lda #0
	loop_i_clr2:
	...
	; $07d8～$07ff char_12_type01_y2 ～ char_12_type12_x2
	lda #< char_12_type01_y2;下位
	sta REG0
	lda #> char_12_type01_y2;上位
	sta REG1
	ldy #0
	lda #0
	loop_i_clr3:
