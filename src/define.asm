...
tamanegi00_status							= $D1	; タマネギ00状態(0:大砲の中、1:放物線、2:通常、3:炎上)
tamanegi01_status							= $D2	; タマネギ01状態
tamanegi00_wait								= $D3	; タマネギ00待ち
tamanegi01_wait								= $D4	; タマネギ01待ち
tamanegi00_update_step						= $D5	; タマネギ00共通内部更新ステップ
tamanegi01_update_step						= $D6	; タマネギ01共通内部更新ステップ
tamanegi00_spd_y							= $D7	; Y方向速度（+1は小数部）
tamanegi01_spd_y							= $D8	; Y方向速度（+1は小数部）
tamanegi00_spd_y_decimal					= $D9	; 小数部
tamanegi01_spd_y_decimal					= $DA	; 小数部
tamanegi00_spd_vec							= $DB	; 速度方向（0下方向、1上方向）
tamanegi01_spd_vec							= $DC	; 速度方向（0下方向、1上方向）
cannon_world_x_low							= $DD
cannon_world_x_hi							= $DE
cannon_y									= $DF
cannon_alive_flag							= $E0
palette_change_state						= $E1	; パレットチェンジ用(0:なにもしない、1:2をタマネギ、2:4を炎)
fire_alive_flag								= $E2	; 炎生きているフラグ
fire_max_count								= $E3	; 最大同時数
fire_alive_flag_current						= $E4	; フラグ参照現在位置
fire0_world_x_low							= $E5
fire1_world_x_low							= $E6
fire0_world_x_hi							= $E7
fire1_world_x_hi							= $E8
fire0_y										= $E9
fire1_y										= $EA
